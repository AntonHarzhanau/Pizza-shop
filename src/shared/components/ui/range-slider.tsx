    ...
    (
        ...
        return (
            <SliderPrimitive.Root
                ...
                className={cn('relative flex w-full touch-none select-none mb-6 items-center',)}
                {...props}
            >
                <SliderPrimitive.Track className="relative h-1 grow overflow-hidden rounded-full bg-primary/20">
